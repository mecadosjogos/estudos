...
const CACHE_NAME = "estudos-review-v2";
...
self.addEventListener("fetch", (event) => {
	...
	// network-first pra tudo (fila e CSS/JS): com sinal, sempre a versão do
	// último deploy; cache é só o fallback pra quando o sinal cai no meio do
	// trajeto. Cache-first nos estáticos prendia o style.css antigo aqui.
	event.respondWith(
		fetch(request)
			.then((response) => {
